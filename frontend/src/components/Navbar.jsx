...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-pastel-lavender/50 dark:border-gray-800 transition-colors">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-white dark:bg-gray-900 border-t border-pastel-lavender/50 dark:border-gray-800"
          >
