...
const TopNavbar = ({ onMenuClick }) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-40 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-pastel-lavender/50 px-4 py-2.5">
        {/* Mobile menu button */}
        ...
        <div className="flex items-center gap-4">
          ...
          {/* 🤖 SheSphere AI button — replaces the old HelpCircle icon */}
          <button
            id="shesphere-ai-btn"
            onClick={() => setIsChatOpen(true)}
            title="SheSphere AI"
            className="flex items-center gap-1.5 text-gray-600 hover:text-pink-500 transition-colors group"
      ...
      {/* AI Chatbot panel — rendered outside header to avoid z-index clipping */}
